...
@click.option('--table-properties', help='Path to a JSON file containing table properties')
...
def convert(csv_file: str, delimiter: str, has_header: bool, quote_char: str, batch_size: int,
            ...
            include_columns: Optional[str], exclude_columns: Optional[str], table_properties: Optional[str], verbose: bool):
    """
